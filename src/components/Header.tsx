...
export const Header = ({
  ...
  return <header className="relative z-10 bg-white/90 backdrop-blur-sm shadow-lg border-b-4" style={{
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4 flex-1 md:flex-none">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-xs md:text-sm font-medium" style={{
              color: settings.secondary_color || '#3b82f6'
            }}>
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            color: settings.text_color || '#1e293b'
              ...
              <p className="text-xs md:text-sm font-semibold cursor-pointer hover:opacity-80 transition-opacity" onClick={handlePhoneClick} title="Jetzt anrufen" style={{
              color: settings.secondary_color || '#3b82f6'
            }}>
                ☎ 06353 - 93 220 70
              </p>
              <Button onClick={handlePhoneClick} className="mt-1 md:mt-2 text-white text-xs px-2 py-1 md:px-3 hover:opacity-90" style={{
